...
const AgencyIcon = () => (
  <div className="w-12 h-12 rounded-2xl bg-[#256D85]/10 flex items-center justify-center">
    <svg className="w-6 h-6 text-[#256D85]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    ...
    <div className="min-h-screen bg-[#fefdfd] flex flex-col" style={{ fontFamily: 'var(--font-space-grotesk)' }}>
      ...
      <main className="flex-1 px-6 py-16">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="text-center bg-[#256D85]/5 border border-[#256D85]/10 rounded-2xl p-8">
