...
const collageColumns: {
  ...
  text: string;
    ...
    [
      { src: "https://cohesive-b0d5d2agc3g8bgha.z03.azurefd.net/landing-assets/hvac.png?w=800&q=80&auto=format", alt: "HVAC", weight: 1.40, mode: "text", text: "Find property managers with aging rooftop units, then reach out before their next service window." },
      { src: "https://cohesive-b0d5d2agc3g8bgha.z03.azurefd.net/landing-assets/plumbing-contractor.jpg?w=800&q=80&auto=format", alt: "Plumbing", weight: 0.95, mode: "image", text: "Find older multi-family buildings nearby, then reach out the moment a freeze hits." },
      { src: "https://cohesive-b0d5d2agc3g8bgha.z03.azurefd.net/landing-assets/power-washing.jpg?w=800&q=80&auto=format", alt: "Power Washing", weight: 0.85, mode: "text", text: "Find strip malls in your area, then reach out before their peak retail season." },
    ],
    [
      { src: "https://cohesive-b0d5d2agc3g8bgha.z03.azurefd.net/landing-assets/landscaping.avif?w=800&q=80&auto=format", alt: "Landscaping", weight: 1.00, mode: "image", text: "Find office parks with contracts ending soon, then reach out before renewal." },
      { src: "https://cohesive-b0d5d2agc3g8bgha.z03.azurefd.net/landing-assets/expory-flooring.png?w=800&q=80&auto=format", alt: "Epoxy Flooring", weight: 1.00, mode: "text", text: "Find new auto shops mid-buildout, then reach out the same week they break ground." },
      { src: "https://cohesive-b0d5d2agc3g8bgha.z03.azurefd.net/landing-assets/window-washing.avif?w=800&q=80&auto=format", alt: "Window Washing", weight: 1.2, mode: "image", text: "Find high-rise offices in your service area, then reach out on a quarterly cadence." },
    ],
    [
      { src: "https://cohesive-b0d5d2agc3g8bgha.z03.azurefd.net/landing-assets/kitchen-hood.png?w=800&q=80&auto=format", alt: "Kitchen Hood", weight: 1.50, mode: "text", text: "Find restaurants nearby, then reach out before their next NFPA-96 inspection deadline." },
      { src: "https://cohesive-b0d5d2agc3g8bgha.z03.azurefd.net/landing-assets/roofing.avif?w=800&q=80&auto=format", alt: "Roofing", weight: 1.00, mode: "image", text: "Find school districts with aging roofs, then reach out before the summer maintenance window." },
    ],
    [
      { src: "https://cohesive-b0d5d2agc3g8bgha.z03.azurefd.net/landing-assets/painting.avif?w=800&q=80&auto=format", alt: "Painting", weight: 1.00, mode: "image", text: "Find churches planning a refresh, then reach out before their next capital campaign closes." },
      { src: "https://cohesive-b0d5d2agc3g8bgha.z03.azurefd.net/landing-assets/pest-control.png?w=800&q=80&auto=format", alt: "Pest Control", weight: 1.00, mode: "image", text: "Find hotels with seasonal pest pressure, then reach out the week activity spikes." },
      { src: "https://cohesive-b0d5d2agc3g8bgha.z03.azurefd.net/landing-assets/commercial-lighting.png?w=800&q=80&auto=format", alt: "Commercial Lighting", weight: 1.00, mode: "text", text: "Find warehouses due for retrofits, then reach out while utility rebate windows are open." },
    ],
  ];
        ...
        <div ref={headerRef} className="mx-auto liquid-glass px-4 py-2 rounded-full transition-all duration-500 ease-[cubic-bezier(0.4,0,0.2,1)]">
          <div className="flex justify-between items-center">
            ...
            <nav className="hidden md:flex items-center bg-white/40 rounded-full px-1 py-1 gap-1">
              ...
              <a href="/api-docs" className="text-gray-700 hover:text-[#2141EC] hover:bg-white/60 transition-all font-medium px-4 py-1.5 rounded-full">Developers</a>
      ...
      <section className="relative py-28 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="flex flex-col w-full justify-center items-center max-w-5xl mx-auto text-center relative mb-[45vh] z-10">
          ...
          <p className="animate-fade-up-delay-2 text-base md:text-lg text-gray-600 mb-8 max-w-2xl mx-auto leading-relaxed">
            Multi-channel outreach to businesses and commercial properties in your area. Done for you on auto-pilot.
          </p>
        ...
        <div className="max-w-[70rem] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-x-16 gap-y-8 text-sm text-gray-600 leading-relaxed">
            <div className="space-y-14 max-w-prose md:justify-self-end">
              <p>
                We&apos;re a team of engineers, marketers, and a few of us who actually came out of the trades. We didn&apos;t study this industry from a slide deck. Some of us drove the trucks and quoted the jobs ourselves, and we got tired of watching good leads die in a notes app because nothing we used was built for how the work really happens.
              </p>
              <p>
                You know the feeling. A phone full of sticky notes, a voicemail you keep meaning to return, evenings eaten by paperwork instead of dinner at home. The competitor who got the contract because they called back first. A $40k job that quietly disappears because an estimate sat in your drafts for three days, or a property manager&apos;s assistant never saw the follow-up you thought you sent. The job itself is already hard enough.
              </p>
            </div>
            <div className="space-y-14 max-w-prose md:justify-self-start">
              <p>
                So we built Cohesive. Not another do-everything platform stuffed with tabs nobody opens, but software shaped around the way HVAC techs, roofers, cleaners, plumbers, and every other trade pro out there actually runs their day and grows the business.
              </p>
              <p>
                We spend most of our time on the boring parts of running a service business. The follow-up that doesn&apos;t happen. The quote that never goes out. The recurring contract that quietly lapses. That&apos;s where most of the lost revenue lives. Cohesive handles the stuff you shouldn&apos;t have to remember, so you can focus on the parts only you can do: showing up, doing good work, and earning the next call.
              </p>
              <p className="text-gray-900 font-medium">
                We&apos;re building the tool we wish we&apos;d had. And we&apos;re just getting started.
              </p>
            </div>
          </div>
        </div>
